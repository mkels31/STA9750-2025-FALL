...
The analysis and visualizations directly address the question of whether neighborhoods with higher poverty rates also experience more critical health violations. By combining DOHMH restaurant inspection data with Community Health Profiles, we were able to calculate the proportion of critical violations for each neighborhood and compare it against poverty rates. Both the scatter plot of critical violation rates versus poverty and the mapped visualizations show that neighborhoods with higher poverty do not consistently exhibit higher rates of critical violations. Instead, critical violations appear relatively uniform across neighborhoods, regardless of socioeconomic status. This suggests that, in New York City, poverty alone is not a strong predictor of critical restaurant health violations, indicating that other factors—such as inspection frequency, restaurant density, or regulatory enforcement—may play a larger role in determining health outcomes at the neighborhood level.
...
In the broader context of the project, which seeks to understand how restaurant quality relates to community health across New York City neighborhoods, these findings suggest that restaurant inspections alone may not fully capture disparities in community health. While higher poverty is often associated with poorer health outcomes, our analysis shows that neighborhoods with higher poverty do not necessarily experience more critical restaurant violations. This indicates that restaurant safety violations are distributed fairly evenly across the city, and other neighborhood-level factors—such as access to healthcare, prevalence of chronic conditions, or environmental factors—may have a stronger influence on overall community health. Thus, while restaurant quality is an important component of public health, it appears to be just one piece of a much larger and more complex picture of health equity across NYC neighborhoods.
